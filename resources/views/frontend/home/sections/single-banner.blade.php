            ...
            <div class="col-xl-6 col-lg-6">
                ...
                <div class="wsus__single_banner_content">
                    <a href="{{$homepage_secion_banner_two->banner_one->banner_url}}">
                        <img class="img-gluid" width="100%" height="100%" src="{{asset($homepage_secion_banner_two->banner_one->banner_image)}}" alt="">
                    </a>
                </div>
                @endif
            </div>
            <div class="col-xl-6 col-lg-6">
                ...
                <div class="wsus__single_banner_content">
                    <a href="{{$homepage_secion_banner_two->banner_two->banner_url}}">
                        <img class="img-gluid" width="100%" height="100%" src="{{asset($homepage_secion_banner_two->banner_two->banner_image)}}" alt="">
                    </a>
                </div>
                @endif
            </div>
