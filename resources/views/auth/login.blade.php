                                ...
                                <div class="wsus__login">
                                    <form method="post" action="{{ route('login') }}">
                                        ...
                                        <div class="wsus__login_input">
                                            ...
                                            <input type="text" placeholder="Email" name="email" id="email" value="{{ old('email') }}" required>
                                        </div>
                                        <div class="wsus__login_input">
                                        ...
                                        <div class="wsus__login_save">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" name="remember" type="checkbox" id="flexSwitchCheckDefault remember_me">
